...
#else
#define RESPONSE_STREAM_BUFFER_SIZE CONFIG_TCP_MSS // use TCP MSS as default buffer size
#endif
...
#else
#ifdef ASYNCTCP_VERSION_PATCH
    return static_cast<tcp_state>(_server.status());
#else
    return static_cast<tcp_state>(0); // AsyncTCPSock
#endif
#endif
  }
#endif
